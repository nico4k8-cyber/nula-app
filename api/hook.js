...
1) Первое предложение всегда СТРОГО такое: «Вот наш маршрут: разберём условие → найдём где загвоздка → придумаем идеи → выберем лучшую.»
2) Второе предложение — опиши ситуацию из задачи ярко и живо. Ключевые существительные выдели жирным: **вот так**.
3) Третье предложение — один короткий вопрос-приглашение начать думать. НЕ зондируй тему, НЕ спрашивай про свойства объектов.
