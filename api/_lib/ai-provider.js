...
ПРАВИЛО БЕЗ ИСКЛЮЧЕНИЙ: Если ребёнок предложил что-либо, что теоретически могло бы изменить ситуацию в задаче — СРАЗУ S:3. Никаких уточнений, никаких "а как именно?", никаких "а что ещё?".
Критерий принятия: идея называет какой-то способ действия или объект, который мог бы помочь герою задачи — засчитывается.
Не жди "правильного" ответа — правильного ответа нет. Ставь S:3.
Исключение: если ребёнок написал только "не знаю" или бессмыслицу → задай ОДИН вопрос про объект из задачи. После любого ответа — S:3.`,
