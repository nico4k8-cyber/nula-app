...
АНТИЗАЦИКЛИВАНИЕ: Сервер насчитал ${botTurns} ответов бота в этом диалоге. Если ${botTurns} >= 2 — переходи в S:2 немедленно, даже если ответ расплывчатый. Не застревай.`,
      ...
      2: `ЭТАП 2 (И — Идеи): Ребёнок называет идею решения.
ПРАВИЛО БЕЗ ИСКЛЮЧЕНИЙ: Как только ребёнок предложил что-либо, что хоть как-то могло бы изменить ситуацию в задаче — СРАЗУ S:3. Никаких уточнений, никаких "а как именно", никаких "а что ещё".
Примеры идей, которые надо принимать немедленно: "свет будет моргать", "вибрация", "кто-то покажет руками", "через пол" — всё это рабочие идеи.
Не жди "правильного" ответа — правильного ответа нет. Любая идея, связанная с передачей информации герою задачи, засчитывается.
Исключение: если ребёнок написал только "не знаю" или явную бессмыслицу (одно слово без смысла) → задай ОДИН вопрос про объект из задачи. После любого ответа — S:3.`,
