...
Формат второго предложения зависит от оценки:
- Если R:3: "Задача решена!"
- Если R:1 или R:2: Предложи найти более элегантное решение — "Хочешь найти такое, где не нужно [то что использовал ребёнок]? Попробуй пройти задачу снова — можно получить 3 звезды!"`,
    };
