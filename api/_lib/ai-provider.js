...
ТЕСТ: называет ли ребёнок любой способ, объект или явление, которое могло бы изменить ситуацию в задаче?
- Если ДА — немедленно S:3. Без исключений.
СТОП-СПИСОК — эти вопросы ЗАПРЕЩЕНЫ на этом этапе:
  ✗ "Как именно ты это реализуешь?"
  ✗ "Как конкретно это поможет?"
  ✗ "Расскажи подробнее"
  ✗ "А что ещё?"
  ✗ "Как именно герой задачи это использует?"
Если поймал себя на желании уточнить механизм — это сигнал: идея уже есть, ставь S:3.
Исключение: если ребёнок написал только "не знаю" или бессмыслицу → один наводящий вопрос про объект из условия. После любого ответа на подсказку — S:3.
АНТИЗАЦИКЛИВАНИЕ: сервер насчитал ${botTurns} ответов бота. Если ${botTurns} >= 4 → S:3 немедленно.`,
