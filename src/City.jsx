            ...
            <div className="w-full max-w-lg bg-white rounded-[48px] shadow-full overflow-hidden flex flex-col relative animate-slide-up">
              <div className="h-56 bg-slate-900 relative overflow-hidden">
                 ...
                 <div className="absolute bottom-10 left-10 text-white">
                    <h2 className="text-4xl font-black uppercase tracking-tighter mb-1 font-display">{islandData?.name}</h2>
                    <div className="flex items-center gap-3 px-3 py-1 bg-white/10 rounded-full w-fit backdrop-blur-md border border-white/5">
                       <span className="text-[9px] font-black uppercase tracking-[0.2em] text-white/70">Выберите локацию</span>
                    </div>
                 </div>
              </div>
                ...
                {islandData?.buildings.map((b, idx) => (
                  ...
                  >
                    ...
                    <div className="flex-1 text-left">
                       <h3 className="text-xl font-black font-display text-slate-800 uppercase tracking-tight">{b.name}</h3>
                       <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest mt-1">Перейти к задачам</p>
                    </div>
          ...
          <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-50 flex gap-4 pointer-events-none animate-fade-in">
            <div className="px-8 py-4 glass-dark rounded-full border border-white/10 text-center flex items-center gap-8 shadow-premium">
              <div className="flex flex-col items-center">
                ...
                <p className="text-[8px] text-white/40 uppercase font-black tracking-[0.2em] mt-1">Миссий</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-[8px] text-white/40 uppercase font-black tracking-[0.2em] mt-1">Островов</p>
              </div>
            </div>
          </div>
        )}
