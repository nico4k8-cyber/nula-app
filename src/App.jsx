...
export default function App() {
  ...
  // Логирование диалога в Telegram при завершении задачи (fire-and-forget, через сервер)
  const sendDialogLog = useCallback((currentTask, currentMessages, stars, solution) => {
    fetch('/api/log-dialog', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
