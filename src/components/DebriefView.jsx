      ...
      <div className="flex flex-col flex-1 justify-center items-center gap-5 mt-4">
        ...
        <div className="text-center">
          <h3 className="text-2xl font-black text-slate-800 mb-1">
            {debriefBingo ? "Разгадано блестяще!" : "Именно так!"}
          </h3>
          <p className="text-slate-400 font-bold text-[12px] uppercase tracking-widest">Метод открыт</p>
        </div>
        ...
        <div className="bg-amber-50 border-2 border-amber-100 rounded-[24px] p-5 text-[15px] text-amber-900 shadow-sm relative overflow-hidden">
          ...
          <div className="flex gap-4">
            ...
            <p className="leading-relaxed">
              <span className="font-black block mb-1 text-amber-600 uppercase text-[11px] tracking-wider">Наставник говорит:</span>
              Этот мир разгадан! Ты открыл <span className="font-bold underline decoration-2 decoration-amber-300">"{task.trick.name}"</span> — мощный инструмент, которым природа пользуется миллионы лет.
            </p>
          </div>
        </div>
        ...
        <div className="w-full rounded-[24px] p-6 border-4 shadow-xl transition-transform hover:scale-[1.02]" 
          ...
          <p className="font-black text-[11px] mb-3 uppercase tracking-[0.2em]" style={{ color: task.trick.color }}>🔑 ТРИЗ МЕТОД</p>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-[13px] text-slate-600 leading-relaxed mb-3">
                  Спасибо! Это решение спасёт мой день. Теперь ответь на вопрос...
                </p>
        ...
        {sessionStars > 0 && (
          <div className="text-center py-4 px-6 bg-yellow-50 rounded-full border border-yellow-100 animate-pulse">
            ...
            <p className="text-yellow-700 text-[12px] font-black uppercase tracking-widest">+{sessionStars} к мышлению</p>
          </div>
        )}
