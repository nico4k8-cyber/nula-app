export const TASKS = [
  ...
  },
  {
    ...
    icon: "🧭",
    teaser: "Тесей вошёл в тёмный лабиринт Минотавра. В кармане у него только клубок ниток. Как вернуться обратно?",
    teaser_en: "Theseus entered the dark labyrinth. All he has is a ball of thread. How can he find his way back?",
    difficulty: 1,
  ...
  /* --- ЛАБОРАТОРИЯ (Остров Науки) --- */
  {
    ...
    title_en: "Hot Tea",
    icon: "☕",
    teaser: "Чай слишком горячий. Как быстро охладить без холодильника?",
    teaser_en: "The tea is too hot. How to cool it without a fridge?",
    difficulty: 2,
    core_problem: { need: "охладить чай быстро", obstacle: "холодильника нет, ждать долго" },
    ikr: "Чай сам охлаждается без посторонней помощи",
    resources: [
      { id: "воздух", properties: "окружает чашку, комнатная температура" },
      { id: "ложка", properties: "металлическая, проводит тепло" },
      { id: "блюдце", properties: "плоское, увеличивает площадь поверхности" }
    ],
    trick: { name: "Принцип площади", animal: "🌬️", animalName: "Ветер" },
    customer: { name: "Учёный", emoji: "👨‍🔬" },
    keywords: ["блюдце", "помешать", "поверхность", "площадь", "испарение", "перелить"],
    puzzle: {
      type: "choice",
      question: "Что поможет чаю остыть БЫСТРЕЕ всего?",
      options: ["Накрыть крышкой", "Перелить в блюдце и помешать", "Добавить сахар"],
      answer: 1,
      explanation: "Блюдце увеличивает площадь поверхности, помешивание ускоряет испарение — чай отдаёт тепло быстрее!"
    }
  },
  {
    id: 32,
    category: "laboratory",
    title: "Невидимые чернила",
    title_en: "Invisible Ink",
    icon: "🕵️",
    teaser: "Шпион хочет написать сообщение, которое никто не прочтёт.",
    teaser_en: "A spy wants a message no one else can read.",
    difficulty: 2,
    core_problem: { need: "написать сообщение, которое будет невидимым", obstacle: "обычные чернила видно сразу" },
    ikr: "Сообщение существует, но видно только тому, кто знает секрет",
    resources: [
      { id: "лимонный сок", properties: "прозрачный, меняет цвет при нагреве" },
      { id: "бумага", properties: "белая, поглощает жидкость" },
      { id: "свеча или лампа", properties: "источник тепла" }
    ],
    trick: { name: "Изменение состояния", animal: "🦎", animalName: "Хамелеон" },
    customer: { name: "Шпион", emoji: "🕵️" },
    keywords: ["лимон", "нагреть", "прозрачный", "проявить", "тепло", "невидимый"],
    puzzle: {
      type: "choice",
      question: "Какое вещество подойдёт для невидимых чернил?",
      options: ["Синяя краска", "Лимонный сок", "Чёрный чай"],
      answer: 1,
      explanation: "Лимонный сок прозрачный, но при нагреве окисляется и темнеет — сообщение проявляется!"
    }
  },
  {
    id: 33,
    category: "laboratory",
    title: "Тихий барабан",
    title_en: "Silent Drum",
    icon: "🥁",
    teaser: "Глухой музыкант не слышит ритм. Как ему помочь?",
    teaser_en: "A deaf musician can't hear the rhythm. How to help?",
    difficulty: 3,
    core_problem: { need: "передать ритм музыканту", obstacle: "он не воспринимает звук" },
    ikr: "Ритм передаётся без звука",
    resources: [
      { id: "вибрация", properties: "есть в любом инструменте при игре" },
      { id: "пол", properties: "твёрдый, проводит вибрацию" },
      { id: "руки и тело", properties: "чувствуют прикосновение и вибрацию" }
    ],
    trick: { name: "Переход в другое измерение", animal: "🐬", animalName: "Дельфин" },
    customer: { name: "Музыкант", emoji: "🎵" },
    keywords: ["вибрация", "трогать", "почувствовать", "тело", "кожа", "пол"],
    puzzle: {
      type: "choice",
      question: "Как глухой музыкант может почувствовать ритм?",
      options: ["Надеть наушники погромче", "Положить руки на инструмент и чувствовать вибрацию", "Смотреть на метроном"],
      answer: 1,
      explanation: "Вибрация — это и есть звук, только в другой форме. Бетховен так и делал!"
    }
  },
  {
    id: 34,
    category: "laboratory",
    title: "Плавающий гвоздь",
    title_en: "Floating Nail",
    icon: "🔩",
    teaser: "Металлический гвоздь тонет в воде. Как заставить его плавать?",
    teaser_en: "A metal nail sinks. How to make it float?",
    difficulty: 3,
    core_problem: { need: "удержать металлический гвоздь на поверхности воды", obstacle: "металл тяжелее воды" },
    ikr: "Гвоздь плавает сам, без поплавка",
    resources: [
      { id: "поверхностное натяжение", properties: "вода создаёт упругую плёнку на поверхности" },
      { id: "форма", properties: "горизонтальное положение распределяет вес" }
    ],
    trick: { name: "Поверхностные явления", animal: "🦟", animalName: "Водомерка" },
    customer: { name: "Физик", emoji: "🧲" },
    keywords: ["поверхностное натяжение", "плёнка", "горизонтально", "осторожно", "водомерка"],
    puzzle: {
      type: "choice",
      question: "Что поможет гвоздю не утонуть?",
      options: ["Привязать верёвку", "Положить горизонтально на поверхность воды очень осторожно", "Согнуть гвоздь дугой"],
      answer: 1,
      explanation: "Поверхностное натяжение воды держит гвоздь, если не прорвать плёнку. Так плавает водомерка!"
    }
  }
];
